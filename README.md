...
- バックエンドの新規開発、リプレイス、改修、保守運用の各フェーズで豊富な開発経験があり、バックエンドとフロントエンドの連携を伴うTypeScript + Vue.jsでのフロントエンド開発経験もあります。またAWSでのシステム運用経験もあります。
...
[担当業務1] チケットアプリAPIのリプレイス開発から保守を担当。具体的には下記。
