...
### 大手レコード会社向けチケットアプリのAPI開発/CMS保守/サイト改修【TypeScript, Vue.js, React.js, Laravel, AWS】(2022年〜2023年)
...
- チケットアプリと顧客情報等を含む外部APIの橋渡しとなる中間サーバーAPI開発。
...
- チケットアプリと紐付く管理者用CMSのLaravel, Vueでの保守作業。CSVダウンロード時のデータ処理の修正、CMSでのイベント作成時のリロード処理の修正作業。
